/* PREFACE -> string variable to locate the file you want to convert into txt
*  RESULT -> variable to locate the converted file (.txt file)
*
*  Dependencies:
*  1. [itext library](https://sourceforge.net/projects/itext/?source=directory)
*  2. [Apatche POI-3.10 library](https://www.softpedia.com/get/Programming/Components-Libraries/Apache-POI.shtml)
*/
